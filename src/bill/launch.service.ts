...
import { IFinnancialAccountRepository } from "../finnancial-account/finnancial-account.repository.d";
import { createTransactionContext } from "../data/knex";

export class LaunchService {
  /**
   *
   */
  constructor(private billRepository: IBillRepository, private finnancialAccountRepository: IFinnancialAccountRepository) { }
  ...
  async delete(billId: number, finnancialAccountToReturn: number) {
    ...
    await createTransactionContext([this.billRepository, this.finnancialAccountRepository], async (trx) => {
