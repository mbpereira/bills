...
var FinnancialAccountRepository = /** @class */ (function (_super) {
    ...
    FinnancialAccountRepository.prototype.findById = function (id) {
    ...
    FinnancialAccountRepository.prototype.all = function (limit) {
        return __awaiter(this, void 0, void 0, function () {
            var records;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FinnancialAccountRepository.prototype.add = function (deposit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.queryBuilder.insert(deposit)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    FinnancialAccountRepository.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.queryBuilder.where("id", id)
    ...
    FinnancialAccountRepository.prototype.update = function (id, deposit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.queryBuilder.where("id", id)
